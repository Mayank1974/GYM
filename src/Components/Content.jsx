...
export default function Content() {
  return (
    <div className="h-[100%] mb-20">
      ...
      <div className="training-split bg-slate-100 flex-wrap  mx-auto w-[420px] flex flex-col justify-center items-center  rounded-[10px] shadow-lg shadow-gray-500 px-4 pb-4 m-4">
